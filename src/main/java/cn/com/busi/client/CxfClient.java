...
public class CxfClient {
    ...
    public static void main2() {
        ...
        Client client = dcf.createClient("http://124.71.135.67:8889/services/webService?wsdl");
       //  Client client = dcf.createClient("http://1.85.14.166:829/TransportWebService.asmx?wsdl");
        ...
        try {
            ...
            objects = client.invoke("insertInstitutionInfo",getInfo());
...
//        System.out.println(s);
        String s = "{Jsontype=STRING, Json={\"Table\":[{\"id\":\"2511020072414513600001\",\"name\":\"测试检测站\",\"owner\":\"王总\",\"phone\":\"15000002222\",\"contact\":\"张总\",\"area\":\"610001\",\"address\":\"陕西省西安市\",\"certificate\":\"610001235612\",\"startDate\":\"2020-07-24\",\"endDate\":\"2019-07-24\",\"opFlag\":\"1\",\"opDate\":\"2020-07-24\"}]}}";
        return s;
    }
}
