...
//        Client client = dcf.createClient("http://localhost:8889/services/webService?wsdl");
        ...
        // 需要密码的情况需要加上用户名和密码
        client.getOutInterceptors().add(new LoginInterceptor("admin1", "123456"));
        Object[] objects = new Object[0];
        String imgpath = "D:\\Program Files (x86)\\Thunder Network\\Thunder\\profiles\\Community\\UserImages\\804575733.jpg";
        try {
            // invoke("方法名",参数1,参数2,参数3....);
            objects = client.invoke("insertInstitutionDevice", getInfo(), ImageToBase64(imgpath), ImageToBase64(imgpath), ImageToBase64(imgpath));
